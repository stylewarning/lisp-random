...
Lisp code that I, Robert Smith, have written.

Many of them are simply experiments, especially Lisp language
experiments. Others are demonstrations.
...
were the start to an idea, and then were never finished.

There are some sub-directories. In general, they are not very
meaningful to this repository as a whole organizationally. However,
